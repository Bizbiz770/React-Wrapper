...
function push(routeName, params) {
    ...
    try {
        _navigator.dispatch(native_1.StackActions.push(routeName, ramda_1.defaultTo({}, params)));
    }
    catch (error) {
...
function navigate(name, params) {
    ...
    try {
        _navigator.dispatch(native_1.CommonActions.navigate(name, ramda_1.defaultTo({}, params)));
    }
    catch (error) {
        // console.log('error in navigation', error)
    }
